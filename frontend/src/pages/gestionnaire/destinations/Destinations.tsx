...
import { Globe, Search, Plus, Edit2, Trash2, MapPin, Download, Image, Calendar } from "lucide-react";
import { useDestinations } from "../../../hooks/useDestinations";
import { destinationsService } from "../../../services/destinations.service";
import type { Destination, CreateDestinationData, UpdateDestinationData } from "../../../types/destination.types";
...
const Destinations = () => {
	...
	console.log("[Destinations] Hook state - destinations:", destinations, "loading:", loading);
	...
	const [sortBy, setSortBy] = useState<"country" | "createdAt" | "updatedAt">("createdAt");
	...
	return (
		<>
			<Helmet>
				...
				<meta name="description" content="Gérez les destinations d'études de Paname Consulting" />
			...
			<div className="min-h-screen">
				...
				<div className="bg-white shadow-sm border-b">
					<div className="px-4 sm:px-6 lg:px-8 py-6">
						<div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
							<div>
								<h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Destinations</h1>
				...
				<div className="px-4 sm:px-6 lg:px-8 py-6">
					<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
						<div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
							<div className="flex items-center justify-between mb-2">
								...
								<span className="text-xl sm:text-2xl font-bold text-gray-900">
									{statistics?.total || (Array.isArray(destinations) ? destinations.length : 0)}
								</span>
							</div>
							<p className="text-gray-600 text-xs sm:text-sm">Total Destinations</p>
						</div>
						...
						<div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
							...
							<p className="text-gray-600 text-xs sm:text-sm">Pays disponibles</p>
						</div>
						...
						<div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
							...
							<p className="text-gray-600 text-xs sm:text-sm">Ajoutées récemment</p>
						</div>
					</div>
				</div>
				...
				<div className="px-4 sm:px-6 lg:px-8 pb-8">
						...
						{sortedDestinations.map((destination: Destination) => (
							...
							>
								...
								<div className="p-4 sm:p-6">
									<div className="mb-4">
										<p className="text-gray-600 text-sm line-clamp-3">{destination.text}</p>
									</div>

									<div className="space-y-2 sm:space-y-3">
										{/* Date */}
										<div className="flex items-center justify-between">
											<span className="text-xs sm:text-sm text-gray-500">Ajoutée le</span>
										...
										{/* Image status */}
										<div className="flex items-center justify-between">
											<span className="text-xs sm:text-sm text-gray-500">Image</span>
											<span
					...
					{(!Array.isArray(destinations) || destinations.length === 0) && !loading && (
						<div className="text-center py-12">
							<Globe className="w-12 h-12 text-gray-400 mx-auto mb-4" />
							<p className="text-gray-500 text-lg">Aucune destination trouvée</p>
							<p className="text-gray-400 text-sm mt-2">
								{searchTerm ? "Essayez une autre recherche" : "Commencez par ajouter une destination"}
							</p>
						</div>
					)}
