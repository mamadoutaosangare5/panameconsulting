...
import { Calendar, Edit2, Save, X, Shield, CheckCircle2, Eye, EyeOff, Phone } from "lucide-react";
	...
	return (
		<>
			<Helmet>
				...
				<meta name="description" content="Gérez votre profil administrateur Paname Consulting" />
			...
			<div className="min-h-screen p-4 sm:p-6 font-sans">
				...
				<div className="max-w-3xl mx-auto mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
					<div>
						<h1 className="text-2xl sm:text-3xl font-serif text-slate-900 font-normal">Mon profil</h1>
								...
								{isEditing ? (
									...
									<div className="flex items-center gap-2.5 py-2 border-b border-slate-100">
										...
										<span className="text-sm text-slate-800 font-medium">
											{profile?.firstName || <span className="text-slate-300">—</span>}
										</span>
									</div>
								)}
							</div>
							...
							<div>
								...
								{isEditing ? (
									...
									<div className="flex items-center gap-2.5 py-2 border-b border-slate-100">
										...
										<span className="text-sm text-slate-800 font-medium">
											{profile?.lastName || <span className="text-slate-300">—</span>}
										</span>
									</div>
								)}
							</div>
