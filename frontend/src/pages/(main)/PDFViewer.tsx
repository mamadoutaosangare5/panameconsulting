...
const PDFViewer: React.FC = () => {
	...
	const availableDocuments = ["russie", "turquie", "chine", "chypre", "algerie", "maroc", "france"];
		...
		return (
			<div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
				<div className="bg-white rounded-2xl shadow-lg p-8 max-w-md w-full text-center">
					...
					<p className="text-gray-600 mb-6">Vérification de la disponibilité du document...</p>
				</div>
			</div>
		);
	}
					...
					<div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
						<div className="bg-white rounded-2xl shadow-lg p-8 max-w-md w-full text-center">
							...
							<p className="text-gray-600 mb-6">
								Nous faisons tout notre possible pour rendre ce document disponible dans les plus brefs
								délais. Nos équipes travaillent actuellement à sa finalisation.
							</p>
