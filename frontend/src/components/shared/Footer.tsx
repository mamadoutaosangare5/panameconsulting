				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10">
					...
					<section className="space-y-4 text-left">
						...
						<p className="text-sm leading-relaxed text-sky-700">
							Votre partenaire pour des études internationales réussies. Nous accompagnons les étudiants
							vers les meilleures opportunités académiques à travers le monde.
						</p>
					...
					<section className="space-y-6 text-left md:col-span-2 lg:col-span-1">
						<div className="space-y-4">
							<h2 className="text-lg font-semibold text-sky-600 border-b border-sky-200 pb-2">Contact</h2>
