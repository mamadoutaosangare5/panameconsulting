...
function Header(): React.JSX.Element {
	...
	return (
		...
		>
			...
			<nav className="bg-white shadow-md sm:py-1" role="navigation" aria-label="Menu principal">
				<div className="px-4">
					<div className="flex items-center justify-between py-4 lg:py-1 md:py-0">
						...
						<div className="hidden lg:flex items-center space-x-4">
							...
							{/* Avatar / boutons auth — spinner pendant le chargement initial */}
							{isLoading ? (
								<div className="flex items-center ml-4 md:ml-8" aria-hidden="true">
									<button
										disabled
										className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-gray-300 flex items-center justify-center"
									>
										<div className="w-4 h-4 md:w-5 md:h-5 border-2 border-gray-400 border-t-transparent rounded-full animate-spin"></div>
									</button>
								</div>
						...
						>
							{nav ? <X className="w-6 h-6 text-gray-700" /> : <Menu className="w-6 h-6 text-gray-700" />}
						</button>
					</div>
