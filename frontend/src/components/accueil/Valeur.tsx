  ...
  return (
    <div className="py-16">
      <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div className="mt-12 grid grid-cols-1 gap-8 sm:gap-12 lg:gap-25 sm:grid-cols-2 lg:grid-cols-4">
          <div className="bg-white rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-xl hover:scale-105 hover:border-sky-200 border border-transparent cursor-pointer">
