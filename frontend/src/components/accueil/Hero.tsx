...
const Hero = () => {
  ...
  return (
    <>
      <section className="relative min-h-[80vh] md:min-h-[85vh] flex items-center bg-sky-100 overflow-hidden mt-16 lg:mt-28">
        {/* Fond décoratif */}
        <div className="absolute inset-0 z-0">
          <div className="absolute right-0 top-0 w-full lg:w-1/2 h-full opacity-20 lg:opacity-100">
            <img
        ...
        <div className=" mx-auto px-4 md:px-6 relative z-10">
          <div className="flex flex-col lg:flex-row items-center justify-center gap-8 md:gap-12 lg:gap-16 py-8 md:py-12">
            {/* Partie gauche : texte */}
