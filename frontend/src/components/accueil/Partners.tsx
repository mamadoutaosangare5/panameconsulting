...
const Partners = () => {
  ...
  // ReturnType<typeof setInterval> est portable sans dépendre de NodeJS
  ...
  // useCallback pour stabiliser les références et satisfaire exhaustive-deps
  ...
  // Défilement automatique — nextSlide est stable grâce à useCallback
  useEffect(() => {
  ...
  }, [currentIndex, visibleCards, isPaused, nextSlide]);
