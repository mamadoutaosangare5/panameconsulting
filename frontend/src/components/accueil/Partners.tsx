	...
	return (
		<section className="py-32 bg-sky-50 overflow-hidden">
			<div className="container mx-auto px-4 text-center mb-24">
				<h2 className="text-5xl font-black text-sky-900 italic uppercase tracking-widest">Network</h2>
				<p className="text-sky-500 font-bold mt-2">Nos partenaires à travers le monde</p>
			</div>
